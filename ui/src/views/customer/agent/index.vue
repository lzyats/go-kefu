...
const dialog = reactive({
	visible: false,
	form: { agent_id: '', username: '', display_name: '', max_sessions: 5, status: 'enabled', online_status: 'offline' } as Agent,
});
...
const openDialog = (row?: Agent) => {
	dialog.form = row ? { ...row } : { agent_id: '', username: '', display_name: '', max_sessions: 5, status: 'enabled', online_status: 'offline' };
	dialog.visible = true;
};
