...
import { customerRoutes, dynamicRoutes, notFoundAndNoPower } from '/@/router/route';
...
export function setFilterRouteEnd() {
	...
	filterRouteEnd[0].children = [...setFilterRoute(filterRouteEnd[0].children), ...customerRoutes, ...notFoundAndNoPower];
...
export function setFilterMenuAndCacheTagsViewRoutes() {
	...
	const { userInfos } = storeToRefs(stores);
	storesRoutesList.setRoutesList(setFilterHasRolesMenu([...dynamicRoutes[0].children, ...customerRoutes], userInfos.value.roles));
