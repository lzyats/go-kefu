		...
		children: [
			{
				...
				component: () => import('/@/views/customer/workbench/index.vue'),
				meta: {
					title: '坐席工作台',
					isLink: '',
					isHide: false,
			...
			{
				path: '/customer/tenant',
				name: 'customerTenant',
				component: () => import('/@/views/customer/tenant/index.vue'),
				meta: {
					title: '租户管理',
					isLink: '',
					isHide: false,
			...
			},
			{
				path: '/customer/agent',
				name: 'customerAgent',
				component: () => import('/@/views/customer/agent/index.vue'),
				meta: {
					title: '坐席管理',
					isLink: '',
					isHide: false,
			...
			},
			{
				...
				component: () => import('/@/views/customer/session/index.vue'),
				meta: {
					title: '会话监控',
					isLink: '',
					isHide: false,
			...
			},
			{
				path: '/customer/risk',
				name: 'customerRisk',
				component: () => import('/@/views/customer/risk/index.vue'),
				meta: {
					title: '敏感词/风控',
					isLink: '',
					isHide: false,
...
export const staticRoutes: Array<RouteRecordRaw> = [
	...
	},
	{
		path: '/kefu/chat',
		name: 'kefuClientChat',
		component: () => import('/@/views/customer/client/index.vue'),
		meta: {
			title: '在线客服',
			isPublic: true,
		},
